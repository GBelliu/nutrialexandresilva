...
export function ComoFunciona() {
  return (
    <Container>
      <Content>
        <h1>
          Como funciona a <br /> Mentoria <span>Consultório Prime</span>
        </h1>
        <Text>
          <p>
          ...
          <p>
            Durante a mentoria você terá acesso exclusivo a 8 módulos que te
            ajudarão a <span>alavancar</span> ainda mais <span>rápido</span> seu
            negócio.
          </p>
          <p>
